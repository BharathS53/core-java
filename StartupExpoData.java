class StartupExpoData
 {
    public static void main(String[] args) {
        ...
        String[] names = {"StartupIndia", "InnovateHub", "LaunchFest", "VCConnect", "Disrupt", "PitchSummit", "IdeaToMarket", "StartupWeekend", "FoundersMeet", "BuildAndBoom"};
